...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['document_number'])) {
    ...
    $query = "SELECT p.id AS idPersona, p.nombrePrimer AS primerNombre, p.nombreSegundo AS segundoNombre, 
                     ...
                     hc.fechaIngreso, hc.horaIngreso, hc.idPersonalmedico, hc.idDomicilioPaciente, hc.idDiagnosticoAlta, hc.idAnamnesis, hc.idDestinoPaciente, hc.idAtencionObservacion, hc.idExamenFisico, hc.id AS idPaciente
              FROM persona p
...
<form id="editForm" action="actualizar_historia_clinica.php" method="post">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <input type="text" id="saturacion" name="saturacion" value="<?php echo isset($datosUsuario['saturacionOxigeno']) ? $datosUsuario['saturacionOxigeno'] : ''; ?>">
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <textarea id="examenAuxiliares" name="examenAuxiliares"><?php echo isset($datosUsuario['examenesAuxiliares']) ? $datosUsuario['examenesAuxiliares'] : ''; ?></textarea>
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <div class="row">
            <label for="primernombre">Primer Nombre:</label>
            <input type="text" id="primerNombre" name="primerNombre" value="<?php echo isset($datosUsuario['nombrePrimer']) ? $datosUsuario['nombrePrimer'] : ''; ?>">
            <label for="segundonombre">Segundo Nombre:</label>
            <input type="text" id="segundoNombre" name="segundoNombre" value="<?php echo isset($datosUsuario['nombreSegundo']) ? $datosUsuario['nombreSegundo'] : ''; ?>">
        </div>
        <div class="row">
            <label for="apellidopaterno">Apellido Paterno:</label>
            <input type="text" id="apellidoPaterno" name="apellidoPaterno" value="<?php echo isset($datosUsuario['apellidoPaterno']) ? $datosUsuario['apellidoPaterno'] : ''; ?>">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <textarea id="establecimiento" name="establecimiento"><?php echo isset($datosUsuario['establecimientoReferencia']) ? $datosUsuario['establecimientoReferencia'] : ''; ?></textarea>
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <input type="date" id="fechaAtencion" name="fechaAtencion" value="<?php echo isset($datosUsuario['fechaEgreso']) ? $datosUsuario['fechaEgreso'] : ''; ?>">
            <label for="horaAtencion">Hora de Egreso:</label>
            <input type="time" id="horaAtencion" name="horaAtencion" value="<?php echo isset($datosUsuario['horaEgreso']) ? $datosUsuario['horaEgreso'] : ''; ?>">
        </div>
        <div class="row">
            <label for="responsableAlta">Responsable de Alta:</label>
            <input type="text" id="responsableAlta" name="responsableAlta" value="<?php echo isset($datosUsuario['nombreResponsableAlta']) ? $datosUsuario['nombreResponsableAlta'] : ''; ?>">
            <label for="codigoResponsable">Código del Responsable:</label>
            <input type="text" id="codigoResponsable" name="codigoResponsable" value="<?php echo isset($datosUsuario['firma']) ? $datosUsuario['firma'] : ''; ?>">
        </div>
    </fieldset>
